...
export const LoginPage = () => {
  ...
  return (
    <div className="container mx-auto">
      <main className="h-screen grid gap-8 items-center justify-center md:grid-cols-2">
        <section className="">
          <figure>
            <img src={provisional} alt="escudo colegio" />
          </figure>
        </section>
        <section className="form mx-10">
          ...
          <form action="" className="my-6 flex flex-col gap-10">
            ...
            <button
              type="submit"
              className="btn p-2 text-sm font-medium tracking-wide text-white transition duration-300 rounded whitespace-nowrap bg-sky-500 hover:bg-sky-600 focus:bg-sky-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:border-sky-300 disabled:bg-sky-300 disabled:shadow-none"
            >
              <span>Ingresar</span>
            </button>
          </form>
