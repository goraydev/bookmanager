  ...
  return (
    <Layout>
      <div className="flex flex-col h-full md:h-5/6 w-full m-0 p-0 bg-school">
        <h1 className="text-4xl text-center font-semibold text-slate-100 backdrop-blur-md p-4 mx-auto my-2">
          Bienvenido al sistema - Biblioteca Estudiantil de Pedro Pablo
          Atusparia - Vicos
        </h1>
        <div className="cards containerPage grid md:grid-cols-3 gap-4">
          <div className="overflow-hidden text-center backdrop-blur-md  rounded shadow-xl text-white">
            {/*  <!-- Icon --> */}
